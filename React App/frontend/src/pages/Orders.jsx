  ...
  return (
    <>
      ...
      <div className='container'>
        ...
        <div>
          <label className='mr-2' style={{marginRight:'8px'}}>Manufacture:- </label>
          <input type='' name='Make' onChange={handleInputChange}></input>
        </div>
        <div className='mt-2'>
          <label className='mr-2' style={{marginRight:'8px'}}>Model:- </label>
          <input type='' name='Model' onChange={handleInputChange}></input>
        </div>
        <div className='mt-2'>
          <label className='mr-2' style={{marginRight:'8px'}}>Year:- </label>
          <input type='' name='Year' onChange={handleInputChange}></input>
        </div>
        <div className='mt-2'>
          <label className='mr-2' style={{marginRight:'8px'}}>VIN:- </label>
          <input type='' name='VIN' onChange={handleInputChange} className='ml-2'></input>
        </div>
        <div className='mt-2'>
          <label className='mr-2' style={{marginRight:'8px'}}>Price:- </label>
        ...
        <div className='mt-2'>
            <label className='mr-2' style={{marginRight:'8px'}}>File Upload: </label>
...
export function AddCar() {return(<><Orders /></>)}
